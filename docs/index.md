...
<p style="color:var(--md-default-fg-color--light);margin-bottom:1.2rem;font-size:0.92rem;">2 modules &middot; ~120 minutes &middot; Hands-on AI for Webex Messaging with LangChain</p>
...
<span style="font-size:0.78rem;font-weight:600;color:var(--md-default-fg-color--light);">90 min</span>
</div>
...
<div><span style="font-weight:700;color:#0288d1;">2d</span> &middot; AI Rewrite Assistant</div>
</div>
</div>
</div>
</a>
