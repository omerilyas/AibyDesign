# Module 1a: Webex Developer Portal Setup
...
![Copy your Bearer token from the Webex Developer Portal](img/module-1a-001.png)
...
![Create a new Webex Space named "Webex AI Lab"](img/module-1a-002.png)
...
![Navigate to Documentation, Webex Messaging](img/module-1a-003.png)

Select **All APIs**, then navigate to **Rooms > List Rooms**, and press **Run**.

![Run the List Rooms API](img/module-1a-004.png)
...
![Copy the room ID for "Webex AI Lab"](img/module-1a-005.png)
